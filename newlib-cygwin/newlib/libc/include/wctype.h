...
#ifndef _WCTYPE_T_DEFINED_ANDRAOS
#define _WCTYPE_T_DEFINED_ANDRAOS
#ifdef __andraos__
/* Force wctype_t to be unsigned short for MinGW parity */
...
/* If not AndraOS, use standard Newlib logic below */
#ifndef __andraos__
#if !defined(_WCTYPE_T) && !defined(_WCTYPE_T_DEFINED) && !defined(__wctype_t_defined)
#define _WCTYPE_T
#define _WCTYPE_T_DEFINED
#define __wctype_t_defined
...
#if !defined(_WCTRANS_T) && !defined(_WCTRANS_T_DEFINED)
#define _WCTRANS_T
