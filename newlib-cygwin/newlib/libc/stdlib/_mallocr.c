...
#ifdef _LIBC
/* Force-disable Win32 legacy code as it conflicts with Newlib's structure 
   We leave _WIN32 defined to keep MinGW system headers happy if they are pulled in. */
# undef WIN32
#endif
...
#if defined(HAVE_USR_INCLUDE_MALLOC_H) || defined(_LIBC)
